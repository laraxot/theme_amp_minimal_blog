...
<head>
	...
	<meta name="viewport" content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no">
		<title>You searched for - PenNews</title>
	<script async custom-element="amp-form" src="https://cdn.ampproject.org/v0/amp-form-0.1.js"></script>	<link rel="stylesheet" id="font-awesome-css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" type="text/css" media="all">
	<script async custom-element="amp-sidebar" src="https://cdn.ampproject.org/v0/amp-sidebar-0.1.js"></script>
		<link rel="canonical" href="http://pennews.pencidesign.com" />
		...
		<script type="application/ld+json">{"@context":"http:\/\/schema.org","@type":"WebSite","mainEntityOfPage":"http:\/\/pennews.pencidesign.com","publisher":{"@type":"Organization","name":"PenNews","logo":{"@type":"ImageObject","url":"http:\/\/pennews.pencidesign.com\/wp-content\/uploads\/2017\/11\/cropped-logo.png","height":32,"width":32}},"headline":"iPhone X Display","datePublished":"2018-04-10T09:01:56+00:00","dateModified":"2018-04-13T02:40:32+00:00","author":{"@type":"Person","name":"Penci Design"},"image":{"@type":"ImageObject","url":"http:\/\/pennews.pencidesign.com\/wp-content\/uploads\/2018\/04\/iphonex.jpg","width":1200,"height":900}}</script>
		<style amp-custom>
		/* Generic WP styling */
pre {
	display: block;
...
.penci-amp-wrapper .img-holder:before{
	display: block;
	content: "";
	width: 100%;
	padding-top: 66.6667%;
...
.amp-wp-iframe-placeholder {
	background: #dedede url(http://max.pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/images/placeholder-icon.png ) no-repeat center 40%;
...
.penci-amp-archive-page-header .archive-title .fa {
margin-right: 10px;
}
...
.penci-archive__list_posts.listing-1 .post-excerpt,
.penci-archive__list_posts.listing-3 .post-excerpt{
	display: none;
}
...
.penci-archive__list_posts .penci-posted-on,
.penci-archive__list_posts .penci-posted-on a{
	color: #999999;
}
...
.button.add-comment, #respond #submit,
.wpcf7 input[type="submit"],
.widget_wysija input[type="submit"] {
	text-transform: uppercase;
	border-radius: 0;
...
.penci-search-form .search-input {
	position: relative;
}
...
@font-face {
	font-family: 'star';
	src: url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/star.eot');
	src: url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/star.eot?#iefix') format('embedded-opentype'),
	url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/star.woff') format('woff'),
	url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/star.ttf') format('truetype'),
	url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/star.svg#star') format('svg');
	font-weight: normal;
	font-style: normal;
}
...
@font-face {
	...
	src: url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/WooCommerce.eot');
	src: url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/WooCommerce.eot?#iefix') format('embedded-opentype'),
	url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/WooCommerce.woff') format('woff'),
	url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/WooCommerce.ttf') format('truetype'),
	url('http://pennews.pencidesign.com/wp-content/plugins/penci-pennews-amp/assets/fonts/WooCommerce.svg#WooCommerce') format('svg');
	font-weight: normal;
	font-style: normal;
}
/* Product */
.penci-archive__list_product {
	margin: -20px -10px 0;
	overflow: hidden;
}
...
.penci-archive__list_product .penci-product-item:nth-child( 2n+ 1 ) {
	clear: both;
}

.penci-archive__list_product .penci-product-item .article_content{
	position: relative;
	padding:0;
}
...
.penci-product-item .star-rating {
	margin: 0;
	position: absolute;
	top: 16px;
	left: 10px;
...
.penci-product-item .entry-text {
	text-align: center;
}

.penci-product-item .penci__product__title {
	font-size: 18px;
	text-align: center;
	padding: 0;
	margin: 20 0 8px 0;
...
.penci-product-item .penci__product__title a{
	color: #131313;
}

.penci-product-item .penci__product__title a:hover {
	color: #3f51b5;
}

.penci-product-item .woocommerce-price {
	margin: 0;
	text-align: center;
	font-size: 18px;
	color: #313131;
...
.penci-product-item .woocommerce-price del {
	display: inline-block;
	font-size: 16px;
	color: #ccc;
	margin-right: 10px;
...
.penci-product-item .woocommerce-price ins {
	font-weight: normal;
}


.penci-product-item .button {
	font-size: 14px;
	font-weight: bold;
	margin-top: 15px;
	display: block;
...
.penci-amp-product-gallery__image {
	width:33.3333%;
	float:left;
	padding: 10px 5px;
}

.penci-amp-product-gallery__image:nth-child( 3n + 1 ) {
	clear: both;
}


.penci-amp-single-product .star-rating,
.penci-amp-woo-tabs .star-rating {
	float: left;
	overflow: hidden;
	position: relative;
	height: 1em;
...
.penci-amp-single-product .onsale {
	display: none;
}
...
.penci-amp-single-product .woocommerce-review-link {
	position: relative;
	top: -3px;
	padding-left: 5px;
	padding-left: 5px;
...
.penci-amp-woo-tabs .woocommerce-Tabs-panel{
	padding: 10px;
	border-right: 1px solid #dedede;
	border-left: 1px solid #dedede;
}

.penci-amp-woo-tabs section:last-child .woocommerce-Tabs-panel{
	padding: 10px;
	border-bottom: 1px solid #dedede;
}
...
.penci-post-related.products .penci-archive__list_product{
	margin-top: 0;
}
...
font-size:14px;
		...
		#penci-slider-img-holder1990{ background-image:url(http://max.pennews.pencidesign.com/wp-content/uploads/2017/07/tech1-760x570.jpg); }#penci-slider-img-holder1989{ background-image:url(http://max.pennews.pencidesign.com/wp-content/uploads/2017/07/style-760x570.jpg); }#penci-slider-img-holder1985{ background-image:url(http://max.pennews.pencidesign.com/wp-content/uploads/2017/07/housedesign-760x570.jpg); }	</style>
</head>

<body  class="bp-legacy search search-results wp-custom-logo penci-amp-body sticky-header group-blog hfeed header-sticky penci_enable_ajaxsearch penci_enable_retina penci_sticky_content_sidebar blog-default two-sidebar wpb-js-composer js-comp-ver-5.4.5 vc_responsive no-js">
<amp-sidebar id="penci_sidebar" class="mobile-sidebar" layout="nodisplay" side="left">
	<button id="close-sidebar-nav" on="tap:penci_sidebar.close" class="ampstart-btn caps m2"><i class="fa fa-close"></i></button>
	<div id="sidebar-nav-logo">
				<a href="http://pennews.pencidesign.com/amp"
		   class="sidebar-branding penci-amp-site-icon sidebar-image-logo ">
			<amp-img src="http://max.pennews.pencidesign.com/wp-content/uploads/2017/11/cropped-logo.png" alt="PenNews - The Best News &amp; Magazine WordPress Themes" height="50" width="231"></amp-img>		</a>
	</div>
	...
	<nav id="primary-menu-mobile" itemscope itemtype="http://schema.org/SiteNavigationElement" class="mobile-navigation primary-menu-mobile penci-amp-menu"><li id="menu-item-3415" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3415"><a href="/amp/">Home</a></li>
<li id="menu-item-3416" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-3416"><a href="http://pennews.pencidesign.com/amp/category/life-style/fashion/">Fashion</a></li>
<li id="menu-item-3417" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-3417"><a href="http://pennews.pencidesign.com/amp/category/life-style/food/">Food</a></li>
<li id="menu-item-3418" class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-3418"><a href="http://pennews.pencidesign.com/amp/blog/">Blog</a></li>
</nav></amp-sidebar>
...
<div class="penci-amp-wrapper">
	...
	<div>
		<button class="fa fa-bars navbar-toggle" on="tap:penci_sidebar.toggle"></button>
				<a href="http://pennews.pencidesign.com/amp" class="branding  penci-amp-site-icon image-logo "><amp-img src="http://max.pennews.pencidesign.com/wp-content/uploads/2017/11/cropped-logo.png" alt="PenNews - The Best News &amp; Magazine WordPress Themes" height="50" width="231"></amp-img></a>
				<a href="http://pennews.pencidesign.com/amp/?s" class="navbar-search"><i class="fa fa-search" aria-hidden="true"></i></a>
	</div>
</header>
<div class="wrap">
		<form role="search" class="penci-search-form clearfix empty" action="http://pennews.pencidesign.com/amp/" target="_top" novalidate>
...
Content Delivery Network via max.pennews.pencidesign.com
Database Caching 1/27 queries in 0.019 seconds using disk

Served from: pennews.pencidesign.com @ 2018-11-30 11:59:06 by W3 Total Cache
-->
