	...
	<div class="article_content">
		<div class="entry-media">
			<a class="penci-link-post" href="http://pennews.pencidesign.com/amp/head-to-head-apple-macbook-air-vs-microsoft-surface-laptop/">
				<amp-img class="penci-post-thumb" src="{{ asset($row->image_src) }}" alt="" width="480" height="320" layout="responsive"></amp-img>
			</a>
		</div>
		<div class="entry-text">
			...
			<a class="post-read-more" href="{{ $row->url }}" title="{{ $row->title }}">
